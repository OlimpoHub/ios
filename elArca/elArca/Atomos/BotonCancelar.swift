    ...
    var body: some View {
        Button(action: action) {
            Text(title)
                ...
                .foregroundColor(Color(red: 54/255, green: 85/255, blue: 199/255)) // color de texto
                .frame(width: 112, height: 40) // tamaño del botón
                .background(Color(red: 219/255, green: 213/255, blue: 204/255)) // color
                .cornerRadius(8)
        }
    }
}
